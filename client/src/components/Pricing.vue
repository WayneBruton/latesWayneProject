  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Usage (Gb)", align: "center", value: "usageAllowed" },
        { text: "Number of Employees", align: "center", value: "users" },
        {
          text: "Monthly Price",
          align: "right",
          value: "monthly",
        ...
        { text: "Annual Price", align: "right", value: "annual", width: "150" }
      ],
      desserts: [],
      snackBarMessage: "",
      snackbar: false,
      ...
      formAction: process.env.VUE_APP_PAYFAST_URL,
      return_url: "https://www.eccentrictoad.com/return",
      cancel_url: "https://www.eccentrictoad.com/cancel",
      notify_url: "https://www.eccentrictoad.com/notify",
      name_first: "Wayne",
      name_last: "Bruton",
