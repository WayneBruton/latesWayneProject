    ...
    <v-layout column justify-space-around>
      <v-flex md3>
        ...
        <p>
          ...
          <strong>Perfect Staff</strong> or its content suppliers and protected
          by international copyright laws. The compilation of all content on
          this site is the exclusive property of <strong>Perfect Staff</strong>,
          with copyright authorship for this collection by
          <strong>Perfect Staff</strong>, and protected by international
          copyright laws.
        </p>
        <p>
        ...
        <p>
          <strong>Perfect Staff's</strong> trademarks and trade dress may not be
        ...
        <p>
          <strong>Perfect Staff</strong> grants you a limited license to access
          and make personal use of this site and not to download (other than
          page caching) or modify it, or any portion of it, except with express
          written consent of <strong>Perfect Staff</strong>. This license does
          ...
          gathering and extraction tools. This site or any portion of this site
          ...
          consent of <strong>Perfect Staff</strong>. You may not frame or
          ...
          of <strong>Perfect Staff</strong> and our associates without express
          ...
          without the express written consent of <strong>Perfect Staff</strong>.
          Any unauthorized use terminates the permission or license granted by
          <strong>Perfect Staff</strong>. You are granted a limited, revocable,
          and nonexclusive right to create a hyperlink to the home page of
          <strong>Perfect Staff</strong> so long as the link does not portray
          <strong>Perfect Staff</strong>, its associates, or their products or
          services in a false, misleading, derogatory, or otherwise offensive
          matter. You may not use any <strong>Perfect Staff</strong> logo or
        ...
        <p>
          ...
          guardian. <strong>Perfect Staff</strong> and its associates reserve
          the right to refuse service, terminate accounts, remove or edit
          content, or cancel orders in their sole discretion.
        </p>
        <p>
          <strong>REVIEWS, COMMENTS, EMAILS, AND OTHER CONTENT</strong>
        </p>
        <p>
          ...
          content. <strong>Perfect Staff</strong> reserves the right (but not
          the obligation) to remove or edit such content, but does not regularly
          review posted content. If you do post content or submit material, and
          unless we indicate otherwise, you grant
          ...
          in any media. You grant <strong>Perfect Staff</strong> and its
          associates and sublicensees the right to use the name that you submit
          ...
          resulting from content you supply. <strong>Perfect Staff</strong> has
          the right but not the obligation to monitor and edit or remove any
          activity or content. <strong>Perfect Staff</strong> takes no
        ...
        <p>
          ...
          accurate as possible. However, <strong>Perfect Staff</strong> does not
          ...
          offered by <strong>Perfect Staff</strong> itself is not as described,
          your sole remedy is to make contact with us and together we can
        ...
        <p>
          <strong>
            ...
            THE OPERATION OF THIS SITE OR THE INFORMATION, CONTENT, MATERIALS,
            OR PRODUCTS INCLUDED ON THIS SITE. YOU EXPRESSLY AGREE THAT YOUR USE
            OF THIS SITE IS AT YOUR SOLE RISK. TO THE FULL EXTENT PERMISSIBLE BY
            APPLICABLE LAW, <strong>Perfect Staff</strong> DISCLAIMS ALL
            WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO,
            IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR
            PURPOSE. <strong>Perfect Staff</strong> DOES NOT WARRANT THAT THIS
            SITE, ITS SERVERS, OR E-MAIL SENT FROM
            <strong>Perfect Staff</strong> ARE FREE OF VIRUSES OR OTHER HARMFUL
            COMPONENTS.<strong>Perfect Staff</strong> WILL NOT BE LIABLE FOR ANY
            ...
            CONSEQUENTIAL DAMAGES. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS
            ...
            YOU MIGHT HAVE ADDITIONAL RIGHTS. APPLICABLE LAW
          </strong>
        </p>
        <p>
          By visiting
          <strong>Perfect Staff</strong>, you agree that the laws of South
          Africa, without regard to principles of conflict of laws, will govern
          these Conditions of Use and any dispute of any sort that might arise
          between you and <strong>Perfect Staff</strong> or its associates.
        </p>
        <p>
        ...
        <p>
          ...
          <strong>Perfect Staff</strong>.We reserve the right to make changes to
        ...
        <v-btn dark color="#010a43" @click="back">Return</v-btn>
      </v-flex>
    </v-layout>
  </v-container>
</template>
